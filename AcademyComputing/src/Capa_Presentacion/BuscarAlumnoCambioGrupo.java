...
import static Capa_Presentacion.CambioDeGrupo.cGrupo;
import static Capa_Presentacion.CambioDeGrupo.codigoa;
import static Capa_Presentacion.CambioDeGrupo.estado;
import static Capa_Presentacion.CambioDeGrupo.nombrealumno;
import static Capa_Presentacion.CambioDeGrupo.idalumno;
 ...
 * @author GLARA
 */
public class BuscarAlumnoCambioGrupo extends javax.swing.JInternalFrame {
     ...
     */
    public BuscarAlumnoCambioGrupo() {
        initComponents();
        setFiltroTexto();
        addEscapeKey();
        limpiar();
...
//    }
    ...
    private void alumnosKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_alumnosKeyPressed
        ...
        if (key == java.awt.event.KeyEvent.VK_ENTER) {
            ...
            CambioDeGrupo.llenarcombogrupo(alumnos.getValueAt(p, 0).toString());
