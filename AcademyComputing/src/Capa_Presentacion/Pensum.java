 ...
 * @author GLARA
 */
public class Pensum extends javax.swing.JInternalFrame {
    ...
    private void MostrarDatos(String Dato) {
        String[] campos = {"pensum.idpensum", "pensum.descripcion", "carrera.descripcion", "pensum.estado"};
        String[] condiciones = {"pensum.idpensum"};
        String[] Id = {Dato};
...
//        }
        if (this.rbNombres.isSelected()) {
            ...
            Utilidades.setEditableTexto(this.JPanelCampos, false, null, true, "");
            Utilidades.esObligatorio(this.JPanelCampos, false);
            model = peticiones.getRegistroPorLike(model, "pensum", campos, "pensum.descripcion", Dato, inner);
        }
...
//        }
        Utilidades.ajustarAnchoColumnas(pensum);
    }
...
//            Component[] cmps = {descripcion, estado,carrera};
...
//    }
    ...
    private void filaseleccionada() {
        ...
        if (pensum.getValueAt(fila, 0) != null) {
            ...
            String[] campos = {"pensum.descripcion", "carrera.descripcion", "pensum.estado"};
            llenarcombocarrera();
            Utilidades.setEditableTexto(this.JPanelCampos, true, null, true, "");
            ...
            rs = ac.getRegistros("pensum", campos, cond, id, inner);
    ...
    private void initComponents() {
        ...
        carrera.setName("Pensum"); // NOI18N
        JPanelCampos.add(carrera);
        carrera.setBounds(190, 60, 250, 21);
        ...
        descripcion.setBounds(190, 30, 130, 21);
        ...
        pensum.setForeground(new java.awt.Color(51, 51, 51));
        pensum.setModel(model = new DefaultTableModel(null, titulos)
            {
                @Override
            ...
            pensum.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
            pensum.setFocusCycleRoot(true);
            pensum.setGridColor(new java.awt.Color(51, 51, 255));
            pensum.setRowHeight(22);
            pensum.setSelectionBackground(java.awt.SystemColor.activeCaption);
            pensum.setSurrendersFocusOnKeystroke(true);
            pensum.addMouseListener(new java.awt.event.MouseAdapter() {
                public void mouseClicked(java.awt.event.MouseEvent evt) {
                    pensumMouseClicked(evt);
                }
            ...
            jScrollPane1.setViewportView(pensum);
            pensum.getAccessibleContext().setAccessibleName("");
    ...
    private void pensumMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pensumMouseClicked
        // TODO add your handling code here:
        filaseleccionada();

    }//GEN-LAST:event_pensumMouseClicked
    ...
    private void pensumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pensumKeyPressed
        // TODO add your handling code here:
    ...
    private javax.swing.JTable pensum;
